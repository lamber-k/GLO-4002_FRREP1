...
import ca.ulaval.glo4002.Marv1n.web.rest.configuration.EntityManagerContextFilter;
import ca.ulaval.glo4002.Marv1n.web.rest.configuration.LocatorServicesModule;
import ca.ulaval.glo4002.Marv1n.web.rest.configuration.StartupApplication;
...
public class StartupRest {
    ...
    private void configureJersey(ServletContextHandler servletContextHandler) {
        ServletContainer container = new ServletContainer(new ResourceConfig().packages(
                "infrastructure.ca.ulaval.glo4002.Marv1n.web.rest.resources").register(JacksonFeature.class));
