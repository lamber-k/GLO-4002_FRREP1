...
public class RoomTest {
    ...
    @Test
    public void givenNotReservedRoom_WhenReserved_ThenTheRoomIsReserved() throws RoomAlreadyReservedException {
        room.reserve();
    }

    @Test (expected = RoomAlreadyReservedException.class)
    public void givenReservedRoom_WhenReservedAgain_ThenThrowRoomIsAlreadyReserved() throws RoomAlreadyReservedException {
        room.reserve();
        room.reserve();
    }
