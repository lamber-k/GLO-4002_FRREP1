...
public class JavaxMailSenderSMTPSTest {
    ...
    public void initializeMailServiceSMTPS() {
        ...
        mail = initializeMail();
        mailServiceSMTPS = new JavaxMailSenderSMTPS(mailServiceOptions, mailTransporterMock, passwordBasedAuthenticatorMock);
    }
