...
import org.Marv1n.rest.Configuration.EntityManagerContextFilter;
import org.Marv1n.rest.Configuration.StartupApplication;
...
public class StartupRest {
    ...
    private void configureJersey(ServletContextHandler servletContextHandler) {
        ServletContainer container = new ServletContainer(new ResourceConfig().packages(
                "ca.ulaval.glo4002.Marv1n.rest").register(JacksonFeature.class));
